...
class Village:
    def __init__(self, config, level):
        ...
        self.town_hall_obj.level = level
        self.town_hall_obj.health += 10*level 
        self.town_hall_obj.max_health += 10*level 
    ...
    def generate_map(self, level):
        ...
        for hut in self.huts:                                           # hut is 2x2
            ...
            hut_obj.level = level
            hut_obj.max_health += 10*level
            hut_obj.health += 10*level
        ...
        for wall in self.walls_top:                                     # wall is 1x1
            ...
            wall_obj.level = level
            wall_obj.max_health += 40*level
            wall_obj.health += 40*level
        ...
        for cannon in self.cannons:                                     # cannon is 2x2
            ...
            cannon_obj.level = level
            cannon_obj.attack += level
            cannon_obj.attack_radius += (level // 2)
            cannon_obj.max_health += 30*level
            cannon_obj.health += 30*level 
        ...
        for wizard_tower in self.wizard_towers:                          # wizard tower is 1X1
            ...
            wizard_tower_obj.level = level
            wizard_tower_obj.attack += level
            wizard_tower_obj.attack_radius += (level // 2)
            wizard_tower_obj.max_health += 30*level
            wizard_tower_obj.health += 30*level
